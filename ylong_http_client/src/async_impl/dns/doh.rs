...
mod ut_doh_test {
    ...
    /// UT test case for `DohResolver::resolve`
    ///
    /// # Brief
    /// 1. Creates a doh resolver.
    ...
    #[tokio::test]
    #[cfg(feature = "tokio_base")]
    async fn ut_doh_resolver_resolve() {
        let authority = "example.com:0";
        let resolver =
            DohResolver::new("https://1.12.12.12/dns-query").set_ttl(Duration::from_secs(50));
